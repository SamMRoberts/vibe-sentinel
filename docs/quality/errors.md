...
- Add context as errors cross CLI, TUI, storage, or process boundaries without hiding the root cause.
...
- Add tests for failure paths that affect exit behavior, visible UI state, or boundary contracts.
