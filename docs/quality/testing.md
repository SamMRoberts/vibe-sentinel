...
- Keep application-core behavior covered by fast unit tests that run without a terminal, filesystem, clock, or process access.
...
- Add regression tests when a bug crosses a CLI, TUI, or boundary contract.
