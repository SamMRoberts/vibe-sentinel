...
| One-sentence purpose | Rust CLI, ratatui TUI, and MCP feature development under a strict TDD workflow. |
...
| Approval-required changes | Security model changes, public CLI/TUI/MCP/storage contracts, data migrations, dependency swaps, deployment changes, scope expansion, and bypassing TDD gates. |
