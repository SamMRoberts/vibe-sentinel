...
- [x] Approve proposed CLI contract and final architecture pseudocode.
- Validation after this unit: `python3 scripts/validate_tdd_workflow.py docs/exec-plans/active/product-bootstrap.md` passed and planned units have checklist coverage.
...
- [x] Add skeleton-level tests and fixtures.
- Validation after this unit: focused skeleton and unit tests were added and validated before implementation bodies were filled.
...
- Follow-ups:
  ...
  - Plan `status --json` as a separate public CLI contract change before implementation.
